...
if($min && $max) {
    $query = "SELECT value FROM Histogram_View WHERE version = '$version' AND type='$type' AND appName='$app' AND value>='$min' AND value<='$max' ORDER BY value ASC";
}else {
    $query = "SELECT value FROM Histogram_View WHERE version = '$version' AND type='$type' AND appName='$app'  ORDER BY value ASC";
}
