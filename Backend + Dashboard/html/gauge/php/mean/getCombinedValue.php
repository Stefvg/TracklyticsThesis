...
$app = $_GET['app'];
$type = $_GET['type'];
$query = "SELECT name,mean,numberOfMeasurements FROM GaugeAgg_View WHERE appName='$app' AND type='$type'";
...
$query = "SELECT name,AVG(value) as mean, COUNT(*) as count FROM Gauge_View WHERE appName='$app' AND type='$type' GROUP BY name";
$result = mysql_query($query);
if (!$result) {
