 ...
 */
(function(){
    var app = angular.module('lowest', []);


    app.controller("LowestController", ['$http', function($http){
        ...
        $http.get('./php/lowest/getCombinedValue.php?app=' + appName + '&type=' + type).success(function(data) {
        ...
        $http.get('./php/getVersions.php?app=' + appName + '&type=' + type).success(function(data) {
            ...
            for(var i=0; i<controller.versions.length; i++){
                ...
                $http.get('./php/lowest/getData.php?app=' + appName + '&type=' + type + '&version=' + controller.versions[i] + '&number=' + i).success(function(data) {
